/**
 * String similarity utility based on Sorenson-Dice coefficient algorithm. Found here: https://github.com/stephenjjbrown/string-similarity-js
 * Thought I'd use it for the task :)
 */
